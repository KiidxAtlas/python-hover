  ...
  <header class="chrome">
    <div class="chrome-top">
      <div class="chrome-copy">
        ...
        <div class="title">Read official and package docs beside your code</div>
        <div class="subtitle">Designed for deep reading without context switching. Keep controls collapsed for a focused view, then expand when you need to navigate.</div>
      </div>
      <div class="meta-row">
        <span class="pill accent"><strong id="host-pill">Loading…</strong></span>
        <span class="pill">Integrated panel</span>
        <button class="btn sec" id="expand-btn" aria-expanded="false" title="Show or hide docs controls">Show controls</button>
      </div>
    </div>
    <div class="input-row">
