import { REGULAR_HOVER_SECTION_META, RegularHoverSectionId } from '#src/hover/hoverLayout'
...
export class StudioPanel {
  ...
  private renderHtml(webview: vscode.Webview, state: StudioState): string {
    ...
    const sections = [
      this.renderSection('Workspace Actions', 'Run high-frequency commands without leaving Studio.', [
      ...
      this.renderSection('Cache Operations', 'Build, cancel, and clear local corpus and docs cache data.', [
        this.renderActionRow(
      ...
      this.renderSection('Docs Routing And Performance', 'Tune discovery, docs routing, and latency budgets.', [
        this.renderToggleRow(
          'Online discovery',
