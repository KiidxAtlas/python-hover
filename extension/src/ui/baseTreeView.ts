...
export abstract class BaseTreeView<TNode> implements vscode.TreeDataProvider<
  TNode | PlaceholderTreeNode
> {
  protected readonly didChangeTreeDataEmitter = new vscode.EventEmitter<
    TNode | PlaceholderTreeNode | undefined | void
  >()
  ...
  protected isPlaceholderNode(
    element: TNode | PlaceholderTreeNode,
  ): element is PlaceholderTreeNode {
    return (
  ...
  protected themeIconForSymbolKind(
  ...
  protected buildMarkdownTooltip(
    title: string,
