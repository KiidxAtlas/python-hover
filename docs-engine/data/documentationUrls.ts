...
const COMPOUND: Record<string, Info> = {
  ...
  async: {
    title: 'async statement',
    url: 'reference/compound_stmts.html',
    anchor: 'coroutine-function-definition',
  },
  match: {
    ...
    summary:
      'Structural pattern matching — matches a value against a series of patterns. Added in Python 3.10.',
  },
  case: {
    title: 'case clause',
    url: 'reference/compound_stmts.html',
    anchor: 'the-match-statement',
    summary:
      'A pattern clause in a `match` statement. Each `case` specifies a pattern and optional guard condition.',
  },
}
...
const EXPRESSIONS: Record<string, Info> = {
  ...
  in: {
    title: 'in operator',
    url: 'reference/expressions.html',
    anchor: 'membership-test-operations',
  },
  'not in': {
  ...
  'is not': {
    ...
    url: 'reference/expressions.html',
    anchor: 'identity-comparisons',
  },
  'f-string': {
    title: 'f-string',
    url: 'reference/lexical_analysis.html',
    anchor: 'formatted-string-literals',
  },
}
...
const TYPING: Record<string, Info> = {
  ...
  'typing.Optional': {
    ...
    url: 'library/typing.html',
    anchor: 'typing.Optional',
  },
  'typing.Literal': {
  ...
  'typing.TypeVar': {
    ...
    url: 'library/typing.html',
    anchor: 'typing.TypeVar',
  },
  'typing.TypeVarTuple': {
    title: 'typing.TypeVarTuple',
    url: 'library/typing.html',
    anchor: 'typing.TypeVarTuple',
  },
  'typing.ParamSpec': {
    title: 'typing.ParamSpec',
    url: 'library/typing.html',
    anchor: 'typing.ParamSpec',
  },
  'typing.Concatenate': {
    title: 'typing.Concatenate',
    url: 'library/typing.html',
    anchor: 'typing.Concatenate',
  },
  ...
  'typing.Protocol': {
    ...
    url: 'library/typing.html',
    anchor: 'typing.Protocol',
  },
  'typing.runtime_checkable': {
    title: 'typing.runtime_checkable',
    url: 'library/typing.html',
    anchor: 'typing.runtime_checkable',
  },
  'typing.Generic': {
    title: 'typing.Generic',
    url: 'library/typing.html',
    anchor: 'typing.Generic',
  },
  // Named structured types
  'typing.TypedDict': {
    title: 'typing.TypedDict',
    url: 'library/typing.html',
    anchor: 'typing.TypedDict',
  },
  'typing.NamedTuple': {
    title: 'typing.NamedTuple',
    url: 'library/typing.html',
    anchor: 'typing.NamedTuple',
  },
...
const STDLIB_SYMBOLS: Record<string, Info> = {
  ...
  'functools.wraps': {
    ...
    url: 'library/functools.html',
    anchor: 'functools.wraps',
  },
  'functools.lru_cache': {
    title: 'functools.lru_cache',
    url: 'library/functools.html',
    anchor: 'functools.lru_cache',
  },
  'functools.cache': {
  ...
  'functools.partial': {
    ...
    url: 'library/functools.html',
    anchor: 'functools.partial',
  },
  'functools.reduce': {
    title: 'functools.reduce',
    url: 'library/functools.html',
    anchor: 'functools.reduce',
  },
  'functools.cached_property': {
    title: 'functools.cached_property',
    url: 'library/functools.html',
    anchor: 'functools.cached_property',
  },
  'functools.total_ordering': {
    title: 'functools.total_ordering',
    url: 'library/functools.html',
    anchor: 'functools.total_ordering',
  },
  'functools.singledispatch': {
    title: 'functools.singledispatch',
    url: 'library/functools.html',
    anchor: 'functools.singledispatch',
  },
  // contextlib
  'contextlib.contextmanager': {
    title: 'contextlib.contextmanager',
    url: 'library/contextlib.html',
    anchor: 'contextlib.contextmanager',
  },
  'contextlib.asynccontextmanager': {
    title: 'contextlib.asynccontextmanager',
    url: 'library/contextlib.html',
    anchor: 'contextlib.asynccontextmanager',
  },
  'contextlib.suppress': {
    title: 'contextlib.suppress',
    url: 'library/contextlib.html',
    anchor: 'contextlib.suppress',
  },
  'contextlib.AbstractContextManager': {
    title: 'contextlib.AbstractContextManager',
    url: 'library/contextlib.html',
    anchor: 'contextlib.AbstractContextManager',
  },
  // dataclasses
  'dataclasses.dataclass': {
    title: 'dataclasses.dataclass',
    url: 'library/dataclasses.html',
    anchor: 'dataclasses.dataclass',
  },
  'dataclasses.field': {
    title: 'dataclasses.field',
    url: 'library/dataclasses.html',
    anchor: 'dataclasses.field',
  },
  'dataclasses.fields': {
    title: 'dataclasses.fields',
    url: 'library/dataclasses.html',
    anchor: 'dataclasses.fields',
  },
  'dataclasses.asdict': {
    title: 'dataclasses.asdict',
    url: 'library/dataclasses.html',
    anchor: 'dataclasses.asdict',
  },
  'dataclasses.astuple': {
    title: 'dataclasses.astuple',
    url: 'library/dataclasses.html',
    anchor: 'dataclasses.astuple',
  },
  'dataclasses.replace': {
  ...
  'pathlib.PurePath': {
    ...
    url: 'library/pathlib.html',
    anchor: 'pathlib.PurePath',
  },
  'pathlib.PosixPath': {
    title: 'pathlib.PosixPath',
    url: 'library/pathlib.html',
    anchor: 'pathlib.PosixPath',
  },
  'pathlib.WindowsPath': {
    title: 'pathlib.WindowsPath',
    url: 'library/pathlib.html',
    anchor: 'pathlib.WindowsPath',
  },
  // collections
  'collections.namedtuple': {
    title: 'collections.namedtuple',
    url: 'library/collections.html',
  ...
  'collections.defaultdict': {
    ...
    url: 'library/collections.html',
    anchor: 'collections.defaultdict',
  },
  'collections.Counter': {
  ...
  'collections.deque': {
    ...
    url: 'library/collections.html',
    anchor: 'collections.deque',
  },
  'collections.ChainMap': {
    title: 'collections.ChainMap',
    url: 'library/collections.html',
    anchor: 'collections.ChainMap',
  },
  // abc
  ...
  'asyncio.run': {
    title: 'asyncio.run',
    url: 'library/asyncio-runner.html',
    anchor: 'asyncio.run',
  },
  'asyncio.gather': {
    title: 'asyncio.gather',
    url: 'library/asyncio-task.html',
  ...
  'asyncio.Queue': {
    title: 'asyncio.Queue',
    url: 'library/asyncio-queue.html',
    anchor: 'asyncio.Queue',
  },
  // itertools
  'itertools.chain': {
    title: 'itertools.chain',
    url: 'library/itertools.html',
    anchor: 'itertools.chain',
  },
  'itertools.product': {
    title: 'itertools.product',
    url: 'library/itertools.html',
    anchor: 'itertools.product',
  },
